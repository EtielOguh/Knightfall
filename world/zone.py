ZONES = {
    1: {
        "name": "Green Fields",
        "min_level": 1,
        "background": "assets/background/zone_1.png",
    },
    2: {
        "name": "Dark Forest",
        "min_level": 5,
        "background": "assets/background/zone_2.png",
    },
    3: {
        "name": "Ancient Ruins",
        "min_level": 9,
        "background": "assets/background/zone_3.png",
    },
    4: {
        "name": "Cursed Depths",
        "min_level": 13,
        "background": "assets/background/zone_4.png",
    },
}
...
def get_zone_background(zone_id):
    zone = ZONES.get(zone_id)
    if not zone:
        return "assets/background/battle_bg.png"
    return zone.get("background", "assets/background/battle_bg.png")
